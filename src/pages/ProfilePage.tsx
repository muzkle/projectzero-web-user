...
export function ProfilePage() {
  ...
  return (
    <div className="mx-auto grid w-full max-w-6xl gap-6 lg:grid-cols-[320px_1fr] lg:items-start">
      <Card className="text-center lg:sticky lg:top-24">
      ...
      <div className="flex flex-col gap-6">
        {profile?.albumProgress && profile.albumProgress.length > 0 && (
          <section>
            <h3 className="section-title mb-4 text-center lg:text-left">Progresso nos álbuns</h3>
        ...
        {profile?.recentStickers && profile.recentStickers.length > 0 && (
          <section>
            <h3 className="section-title mb-4 text-center lg:text-left">Recentes</h3>
